...
public:
	...
	void onCollision(CollisionEvent& event)
	{
		...
		{
			OnEnemyHitsObscacle(a, b); // "a" is the enemy and "b" is the obstacle. 
		}

		if (a.BelongsToGroup("obstacles") && b.BelongsToGroup("enemies"))
		{
			OnEnemyHitsObscacle(b, a); // "a" is the obstacle and "b" is the enemy. 
		}
		
	}

	void OnEnemyHitsObscacle(Entity enemy, Entity obstacle) 
	{
