...
public: 
	...
	void Update(const std::unique_ptr<AssetStore>& assetStore, SDL_Renderer* renderer, const SDL_Rect& camera)
	{
		for (auto entity : GetSystemEntities()) 
		{
			...
			// Position the health bar indicator in the middle mottom part of the entity sprite
			...
			// Render the percentage text label indicator
